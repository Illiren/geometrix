...
constexpr void constexprTest()
{
    ...
    constexpr auto test10 = Trig::tanDeg<T,true>(T(0));
    constexpr auto test11 = Trig::atan<T,true>(T(0));
    constexpr auto test12 = Trig::atan<T,false>(T(0));
    constexpr auto test13 = Trig::acos<T>(T(0));
    constexpr auto test14 = Trig::asin<T>(T(0));
    constexpr auto test15 = Trig::tan<T,false>(T(0));
    constexpr auto test16 = Trig::tanDeg<T,false>(T(0));
}
...
{    
    ...
    constexprLUTTest<float,&Trig::sin>();
    constexprLUTTest<double,&Trig::sin>();
    constexprLUTTest<float,&Trig::cos>();
    constexprLUTTest<double,&Trig::cos>();
    std::random_device r;
    constexprTest<float>();
